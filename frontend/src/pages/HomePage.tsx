      ...
      <section className="border-t border-bronze/20 bg-parchment py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-8 opacity-70 grayscale transition-all hover:opacity-100 hover:grayscale-0">
            ...
            <span className="text-bronze">•</span>
            <a href="https://data.gov.ro/dataset/bunuri-culturale-clasate-arta" target="_blank" rel="noopener noreferrer" className="text-xl font-heading font-semibold text-charcoal hover:text-gold transition-colors">
              data.gov.ro
            </a>
          </div>
        </div>
